...
export default function forMostPopularAnimePerSeason() {
  ...
  fs.writeFileSync(resolvePath('../src/data/mostPopularAnimePerSeason.json'), JSON.stringify(mostPopularShows))
}